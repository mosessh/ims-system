            ...
            if(auth()->user()->hasRole('staff')) {
                ...
                if($request->has('semester_select')){
                    ...
                    if(isset($semesterStaff)) {
                        ...
                        $request->session()->flash($this->message_warning, 'You are not a valid Staff for target Semester/Term.');
                    }
                }else{
                    $request->session()->flash($this->message_warning, 'Please Filter Attendance with Semester/Term.');
                }
