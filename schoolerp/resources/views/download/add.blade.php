                    ...
                    <div class="col-xs-12 ">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            {{--<div class="alert alert-warning alert-dismissible" role="alert">
                                ...
                                Info: Please, select target Faculty/Class, Sem./Term And Subject for download access permission. Other wise it show all the user.
                            </div>--}}
...
@section('js')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $('.semesters_id').html('').append('<option value="0">Select Sem./Term</option>');
        ...
        function loadSubject($this) {
            ...
            if (semester == 0) {
                toastr.info("Please, Select Sem./Term", "Info:");
                return false;
            }
