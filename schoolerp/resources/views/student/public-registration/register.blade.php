                                ...
                                <div class="col-md-10 col-print-10 align-right">
                                    <div class="text-center">
                                        <h2 class="no-margin-top text-uppercase" style="font-family: 'Merienda', cursive; font-size: 30px">
                                            <strong>{{isset($generalSetting->institute)?$generalSetting->institute:"Ai.ims Web Portal Online Registration"}}</strong>
                                        </h2>
            ...
            <div class="footer-inner hidden-print">
                ...
                <span class="bigger-120">
                    <span class="blue bolder">
                        ...
                        @else
                            <a href="http://businesswithtechnology.com" target="_blank">©Ai.imskenya</a>
                        @endif
                    </span>
                </span>
