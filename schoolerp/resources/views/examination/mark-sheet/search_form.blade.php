            ...
            <div class="panel-body">
                ...
                <div class="clearfix">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            {!! Form::select('faculty', $data['faculties'], null, ['class' => 'form-control chosen-select', 'onChange' => 'load#2e5d8cs(this);']) !!}

                        </div>

                        <label class="col-sm-1 control-label">Sem./Sec.</label>
                        <div class="col-sm-2">
                            <select name="#2e5d8c_select" class="form-control #2e5d8c_select" onChange="loadSubject(this)">
