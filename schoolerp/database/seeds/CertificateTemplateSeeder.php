    ...
    public function run()
    {
        DB::table('certificate_templates')->insert([
            [
                ...
                'template' => '<table class="table table-bordered"> <tbody> <tr> <td>01.</td> <td style="text-align: right; ">Name of Student :&nbsp;</td> <td width="50%" style="text-align: left;"><b>{{student_name}}</b><br></td> </tr> <tr> <td>02.</td> <td style="text-align: right; ">Reg. No.&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{reg_no}}</span><br></td> </tr> <tr> <td>03.</td> <td style="text-align: right; ">ADM. NO.&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{university_reg}}</span><br></td> </tr> <tr> <td>04.</td> <td style="text-align: right; ">Faculty/Level&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{faculty}}</span><br></td> </tr><tr><td>05.</td><td style="text-align: right; ">Batch :&nbsp;<br></td><td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{Batch}}</span><br></td></tr> <tr> <td>06.</td> <td style="text-align: right; ">Year of Study&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><span style="font-weight: 700;">{{year_of_study}}</span><br></td> </tr> <tr> <td>07.</td> <td style="text-align: right; ">Percentage of Attendance Secured&nbsp;:&nbsp;</td> <td width="50%" style="text-align: left;"><b>{{percentage_of_attendance}}%</b><br></td> </tr> </tbody></table>',
            ...
            'custom_css' => '.subpage{padding:83px 5px 5px;color:#000!important}.page-content{padding:8px 20px 24px}h5{font-size:14px;margin:2px auto}h6{font-size:12px;margin:2px auto}.student_image{border-radius:0;width:100px;height:auto;border:2px #2e5d8c solid}p{margin:1px 0 0;font-size:10px;text-align:left!important}',
            'student_photo' => 1,
            'status' => 1
            ],
        ]);
